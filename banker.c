...
int main()
{
    ...
    if (flag == 1)
        printf("Request A: Granted\n");
    else
        printf("Request A: Not Granted\n");
    if (flag == 1)
    {
        for (i = 0; i < 3; i++)
        {
    ...
    if (flag == 1)
        printf("Request B: Granted\n");
    else
        printf("Request B: Not Granted\n");
    if (flag == 1)
    {
        for (i = 0; i < 3; i++)
        {
    ...
    if (flag == 1)
        printf("Request C: Granted\n");
    else
        printf("Request C: Not Granted\n");
    if (flag == 1)
    {
        for (i = 0; i < 3; i++)
        {
